...
当然可以！以下是**更新后的完整 Markdown 笔记文档**，其中包含了 `<code-group>` 标签格式的跨平台安装命令示例，符合你要求的格式风格，适用于技术笔记或知识库展示。
...
如需我为你生成 PDF 或 HTML 格式文档，请告诉我，我可以帮你转换格式。你也可以将此 Markdown 文档保存为 `.md` 文件，作为你的技术笔记长期保留。
