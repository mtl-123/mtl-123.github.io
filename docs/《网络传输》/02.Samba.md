...
sudo apt install samba acl -y  # 安装Samba和ACL工具 [[1]]
```
...
sudo chown -R root:sambashare /home/samba  # 设置所有者为root和sambashare组 [[2]]
sudo chmod -R 2775 /home/samba  # 设置SGID位，确保新文件继承组权限 [[3]]
```
